...
public class DangNhap extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-80, 0, 510, 480));
        ...
        jPanel3.add(btnDangNhap, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 330, -1, 46));
        ...
        try{
            ...
            if(rs.next()){
                if(rs.getString("chucVu").equalsIgnoreCase("Admin")){
                    String a = rs.getString("tenNV");
                    String b = rs.getString("maNV");
                    QuanLy home =new QuanLy();
                    home.tfTenDangNhapNV.setText(a);
                    home.tfmaNV.setText(b);
                    ...
                    nhanVienQL.tfTenDN.setText(b);
                    nhanVienQL.tfmaNV.setText(a);
